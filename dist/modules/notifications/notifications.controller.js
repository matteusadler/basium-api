...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List user notifications (last 50)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Save push subscription for web push' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
