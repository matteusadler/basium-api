...
__decorate([
    (0, common_1.Put)(':id/openai-key'),
    (0, swagger_1.ApiOperation)({ summary: 'Update user OpenAI key (encrypted)' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    ...
    __metadata("design:returntype", Promise)
], UsersController.prototype, "updateOpenAIKey", null);
__decorate([
    (0, common_1.Put)(':id/ai-config'),
    (0, swagger_1.ApiOperation)({ summary: 'Update user AI configuration' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object, update_ai_config_dto_1.UpdateAIConfigDto]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "updateAIConfig", null);
__decorate([
